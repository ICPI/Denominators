...
mer_data_source <- "country_data/2020_q4/MER_Structured_Datasets_Site_IM_FY18-21_20201218_v2_1_Nigeria.txt"
#filename_latlon <- "nigeria/Lat_Long_Nigeria_FacilityReport_2018.rds"
spectrum_data_source <- "application/countries/nigeria/spectrum2.xlsx"
world_pop_source <- "application/countries/nigeria/nga_ppp_2019.tif"
results_location <- "application/countries/nigeria/results/"
time_cuts <- c(-1)
